...
@Component({
      ...
      <div class="auth-layout__right">
        <div class="auth-form-card">
          ...
          <div class="auth-form-card__header">
            <h1 class="auth-form-card__title">Welcome back</h1>
          ...
          <div class="oauth-row">
            ...
            <button class="oauth-btn" (click)="oauthLogin('linkedin')">
            ...
            <button class="oauth-btn" (click)="oauthLogin('microsoft')">
          ...
          <form class="auth-form" (ngSubmit)="onSubmit()" novalidate>
            ...
            <div class="form-field" [class.form-field--error]="passwordTouched && !password">
              <div class="form-field__label-row">
                ...
                <a routerLink="/forgot-password" class="form-field__link">Forgot password?</a>
              </div>
              <div class="form-field__input-wrap">
                <svg class="form-field__icon" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
            ...
            <label class="remember-row">
              <input type="checkbox" [(ngModel)]="rememberMe" name="rememberMe" class="remember-row__check" />
  ...
  styles: [`
    ...
    /* Make the icon also teal on focus via sibling in the wrap */
