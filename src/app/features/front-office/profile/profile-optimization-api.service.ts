...
export class ProfileOptimizationApiService {
  ...
  analyzeLinkedIn(body: LinkedInAnalyzeRequest): Observable<LinkedInProfileDto> {
    ...
    return this.http.post<LinkedInProfileDto>(`${this.base}/linkedin/analyze`, { ...body, userId: id }).pipe(
  ...
  auditGithub(username: string, userId?: string): Observable<GitHubProfileDto> {
    ...
    return this.http.post<GitHubProfileDto>(`${this.base}/github/audit/${encodeURIComponent(username)}`, { userId: id }).pipe(
